#ifndef ROCKET_RPC_NET_RPC_RPC_CHANNEL_H
#define ROCKET_RPC_NET_RPC_RPC_CHANNEL_H
...
class RpcChannel : public google::protobuf::RpcChannel, public std::enable_shared_from_this<RpcChannel> {
  ...
  public:
    ...
    void Init(controller_s_ptr controller, message_s_ptr req, message_s_ptr resp, closure_s_ptr done);
    ...
    google::protobuf::Message* getResposne();
